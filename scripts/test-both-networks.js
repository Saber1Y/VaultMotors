...
async function testBothNetworks() {
  ...
  const abi = ['function getAllCars() external view returns (tuple(uint256,address,string,string[],string,string,string,uint256,string,uint256,string,uint8,uint8,uint8,uint256,string,string[],tuple(string,string,string,uint256,string),bool,bool,uint256,address,uint256)[])']
